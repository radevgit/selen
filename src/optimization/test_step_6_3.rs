...
mod tests {
    ...
    fn create_float_model() -> (Model, Vec<VarId>) {
        ...
        let var0 = model.new_var_float(-10.0, 10.0);
        let var1 = model.new_var_float(0.0, 100.0);
        let var2 = model.new_var_float(-5.0, 5.0);
    ...
    fn create_integer_model() -> (Model, Vec<VarId>) {
        ...
        let var0 = model.new_var_int(1, 10);
        let var1 = model.new_var_int(-5, 5);
        let var2 = model.new_var_int(0, 100);
