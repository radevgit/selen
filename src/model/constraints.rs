...
impl Model {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // 📊 Array Float Constraints (FlatZinc Integration)
    // ═══════════════════════════════════════════════════════════════════════

    /// Find the minimum value in a float array.
    /// 
    /// This implements the FlatZinc `array_float_minimum` constraint.
    ...
    /// 
    /// let min_result = m.array_float_minimum(&[x, y, z]).expect("non-empty array");
    /// ```
    /// 
    /// # Errors
