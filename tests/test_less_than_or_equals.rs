...
fn test_basic_less_than_or_equals() {
    ...
    model.less_than_or_equals(x, int(6));
...
fn test_less_than_or_equals_float_vs_int() {
    ...
    model.less_than_or_equals(x, int(5));
...
fn test_less_than_or_equals_negative_numbers() {
    ...
    model.less_than_or_equals(x, int(-3));
...
fn test_less_than_or_equals_impossible() {
    ...
    model.less_than_or_equals(x, int(5)); // Impossible: no value in [6,10] <= 5
...
fn test_less_than_or_equals_boundary_exact() {
    ...
    model.less_than_or_equals(x, int(5)); // Only x = 5 is valid
...
fn test_less_than_or_equals_chaining() {
    ...
    model.less_than_or_equals(x, y); // x <= y
    model.less_than_or_equals(y, z); // y <= z, so x <= y <= z
...
fn test_less_than_or_equals_with_specific_values() {
    ...
    model.less_than_or_equals(x, int(10));
...
fn test_less_than_or_equals_with_expressions() {
    ...
    model.less_than_or_equals(sum, int(7));
...
fn test_less_than_or_equals_vs_less_than() {
    ...
    model1.less_than_or_equals(x1, int(5));
    model2.less_than(x2, int(5));
...
fn test_less_than_or_equals_precision() {
    ...
    model.less_than_or_equals(x, float(1.5));
...
fn test_less_than_or_equals_ordering_non_strict() {
    ...
    model.less_than_or_equals(vars[0], vars[1]);
    model.less_than_or_equals(vars[1], vars[2]);
