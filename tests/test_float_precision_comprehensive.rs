...
fn test_less_than_precision_complex() {
    ...
    let x = model.new_var_float(1.0, 10.0);
    model.less_than(x, float(5.132415232356));
...
fn test_less_than_precision_very_small() {
    ...
    model.less_than(x, float(0.0000012345));
...
fn test_greater_than_precision_simple() {
    ...
    let x = model.new_var_float(1.0, 10.0);
    model.greater_than(x, float(3.7));
...
fn test_greater_than_precision_complex() {
    ...
    let x = model.new_var_float(1.0, 10.0);
    model.greater_than(x, float(2.987654321098765));
...
fn test_greater_than_precision_near_zero() {
    ...
    model.greater_than(x, float(0.00000789123));
...
fn test_less_than_or_equals_precision() {
    ...
    let x = model.new_var_float(1.0, 10.0);
    model.less_than_or_equals(x, float(4.333333333333333));
...
fn test_greater_than_or_equals_precision() {
    ...
    let x = model.new_var_float(1.0, 10.0);
    model.greater_than_or_equals(x, float(6.777777777777778));
...
fn test_precision_chain_constraints() {
    ...
    model.greater_than(x, float(5.123456789));
    model.less_than(x, float(5.123456790));
...
fn test_precision_multiple_variables() {
    ...
    model1.less_than(x, float(3.14159265359));
    ...
    model2.greater_than(y, float(2.71828182846));
...
fn test_precision_edge_cases() {
    ...
    model.less_than(x, float(std::f64::EPSILON * 2.0));
...
fn test_precision_large_numbers() {
    ...
    model.less_than(x, float(1234567.89012345));
...
fn test_precision_negative_numbers() {
    ...
    model.greater_than(x, float(-3.14159265359));
