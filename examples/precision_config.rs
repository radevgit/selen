...
fn main() {
    ...
    let _var1 = default_model.new_var_float(0.0, 1.0);
    ...
    let _var2 = high_precision_model.new_var_float(0.0, 1.0);
    ...
    let _var3 = low_precision_model.new_var_float(0.0, 1.0);
    ...
    let _int_var_default = default_model.new_var_int(0, 100);
    let _int_var_high = high_precision_model.new_var_int(0, 100);
    let _int_var_low = low_precision_model.new_var_int(0, 100);
